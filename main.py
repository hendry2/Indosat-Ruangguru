...
class Server:
    ...
    def __init__(self):
        ...
        self.mode = ServerInfo.Info('mode').get_info()
        ...
        self.edited = ServerInfo.Info('edited').get_info()
    ...
    def about(self, title = ''):
        ...
        self.info.append('Edited : %s\n' % self.edited)
        self.info.append('Mode : %s\n' % self.mode)
        self.info.append('\n\n')
    ...
    def show(self):
        ...
        time.sleep(2)
        sys.stderr.write(self.log('Suntik Anda Sukses'))
        sys.stderr.write(self.log('127.0.0.1:8989'))
        sys.stderr.write(self.log('Coba Konekan Ke Aplikasi Psihphon Anda\nReading Server:'))
